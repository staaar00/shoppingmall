...
<body>
   ...
   <table class="p">
   		<tr>
   			<td>
   				<img src="image/wallet1.png" class="pic"/>
   			</td>
   			<td style="padding:100px;">
   				<table style="height : 500px; width : 750px;">
   					...
   					<tr align="center">
   						...
   						<td>Classic card holder in imitated soft vegan material. <br>
   						Card holder contains one open pocket and 4 card slots.</td>
   					</tr>
    				</table>
